...
export function getWindowInfo(): WindowInfo {
  return getWindowInfoForWindow();
}

/**
 * Get window info for a specific window, or current window if not specified.
 */
export function getWindowInfoForWindow(windowIndex?: number): WindowInfo {
